...
class Quizz extends Component {
  ...
  constructor(props) {
    ...
    this.quiz_data = [{"AQ_id":1,"AQ_SeqNum":1,"AQ_Question":"ur name?","AQ_Type":"o","AQ_Option1":"a","AQ_Option2":"b","AQ_Option3":"c","AQ_Option4":"d","AQ_AnswerText":"b","AM_id":1,"CO_id":1},{"AQ_id":2,"AQ_SeqNum":2,
  ...
  submitAnswer() {
    if (this.state.selected !== 'None yet!') {
      if (this.state.selected === this.quiz_data[this.state.progress].AQ_AnswerText) {
        this.setState({
    ...
    return (
        ...
        {this.state.progress < this.quiz_data.length ? (
          <div>
              ...
              <Question current_question={this.quiz_data[this.state.progress].AQ_Question} />

              <MultiChoice
                answers={[this.quiz_data[this.state.progress].AQ_Option1,
                this.quiz_data[this.state.progress].AQ_Option2,
                  this.quiz_data[this.state.progress].AQ_Option3,
                  this.quiz_data[this.state.progress].AQ_Option4]
                }
